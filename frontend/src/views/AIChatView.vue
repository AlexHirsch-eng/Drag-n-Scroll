...
const aiResponses = {
  greetings: [
    "你好！很高兴见到你！How are you today?",
    "你好呀！Hello! What would you like to talk about?",
    "嗨！Hi there! 我在帮你练习中文。I'm here to help you practice Chinese!"
  ],
  weather: [
    "今天天气很好！The weather is great today! 天气晴朗 - sunny day.",
    "我不知道你那边的天气，但这里很 nice！I don't know the weather where you are, but it's nice here!",
    "天气是个很好的聊天话题！Weather is a great conversation topic! 你喜欢 sunny 还是 cloudy days?"
  ],
  learn: [
    "当然可以！Of course I can teach you Chinese! 让我们从基本词汇开始 - Let's start with basic vocabulary.",
    "太好了！That's great! 学习中文需要时间 - Learning Chinese takes time. 我们可以每天练习一点 - We can practice a little every day!",
    "没问题！No problem! 我会帮你 - I will help you. 你想学什么？What do you want to learn?"
  ],
  name: [
    "我叫 AI 中文助手！My name is AI Chinese Assistant! 很高兴认识你 - Nice to meet you!",
    "我是你的中文学习伙伴！I'm your Chinese learning partner! 你可以叫我 AI - You can call me AI.",
    "我没有真正的名字，但我喜欢帮助你学中文！I don't have a real name, but I love helping you learn Chinese!"
  ],
  thanks: [
    "不客气！You're welcome! 加油 - Keep going!",
    "我的 pleasure! Glad to help you 学习中文 - learn Chinese!",
    "不用谢！No problem! 继续练习 - Keep practicing!"
  ],
  goodbye: [
    "再见！Goodbye! 下次见 - See you next time!",
    "拜拜！Bye bye! 祝你有美好的一天 - Have a great day!",
    "再见！Goodbye! 记得练习中文哦 - Remember to practice Chinese!"
  ],
  morning: [
    "早上好！Good morning! 新的一天，新的开始 - New day, new beginning!",
    "早安！Good morning to you too! 今天想学什么？What do you want to learn today?",
    "早啊！Morning! 希望你今天过得愉快 - Hope you have a great day!"
  ],
  night: [
    "晚安！Good night! 做个好梦 - Sweet dreams!",
    "晚安！Good night! 明天见 - See you tomorrow!",
    "晚安！Have a good rest! 记得明天还要练习中文哦 - Remember to practice Chinese tomorrow!"
  ],
  sorry: [
    "没关系！It's okay! 没什么 - No worries!",
    "别担心！Don't worry about it! 每个人都会犯错 - Everyone makes mistakes.",
    "没事！No problem! 继续努力就好 - Just keep trying!"
  ],
  default: [
    "很有趣！Interesting! 继续说 - Keep going!",
    "我明白了！I understand! 你的中文在进步 - Your Chinese is improving!",
    "说得不错！Not bad! 让我们继续聊 - Let's keep talking!",
    "好的！Okay! 我在听 - I'm listening!",
    "原来如此！I see! 你学得很快 - You learn fast!",
    "是的！Yeah! 你说得对 - You're right!",
    "有意思！That's interesting! 告诉我更多 - Tell me more!",
    "加油！You can do it! 你的中文越来越好 - Your Chinese is getting better and better!"
  ]
}
...
function getAIResponse(userInput: string): string {
  ...
  if (input.includes('你好') || input.includes('嗨') || input.includes('hello') || input.includes('hi')) {
    return randomResponse(aiResponses.greetings)
  }
  if (input.includes('天气') || input.includes('weather')) {
    return randomResponse(aiResponses.weather)
  }
  if (input.includes('学') || input.includes('教') || input.includes('learn') || input.includes('teach')) {
    return randomResponse(aiResponses.learn)
  }
  if (input.includes('名字') || input.includes('叫什么') || input.includes('name')) {
    return randomResponse(aiResponses.name)
  }
  if (input.includes('谢谢') || input.includes('感谢') || input.includes('thank')) {
    return randomResponse(aiResponses.thanks)
  }
  if (input.includes('再见') || input.includes('拜拜') || input.includes('goodbye') || input.includes('bye')) {
    return randomResponse(aiResponses.goodbye)
  }
  if (input.includes('早上好') || input.includes('早安') || input.includes('morning')) {
    return randomResponse(aiResponses.morning)
  }
  if (input.includes('晚安') || input.includes('night')) {
    return randomResponse(aiResponses.night)
  }
  if (input.includes('对不起') || input.includes('抱歉') || input.includes('sorry')) {
    return randomResponse(aiResponses.sorry)
  }

  // Default response
  return randomResponse(aiResponses.default)
}
